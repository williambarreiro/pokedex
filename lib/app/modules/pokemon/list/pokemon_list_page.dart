...
import 'package:pokedex/app/modules/pokemon/list/widgets/pokemon_list_app_bar.dart';
...
class _PokemonListPageState extends State<PokemonListPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          const PokemonListAppBar(title: 'Pokédex'),
          Expanded(
            child: Container(
                ...
                listener: (context, state) {
                  if (state.status == PokemonListStatus.failure) {
                    ScaffoldMessenger.of(context).showSnackBar(
                      const SnackBar(
                          content: Text('Falha ao carregar Pokémons')),
                    );
                  }
                },
